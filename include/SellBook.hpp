...
namespace MercEx {
    ...
    public:
        ...
        std::map<Price, std::list<Order*>, std::less<>>& get_orders() { return orders_; }
        const std::map<Price, std::list<Order*>, std::less<>>& get_orders() const { return orders_; }
    ...
    private:
        std::map<Price, std::list<Order*>, std::less<>> orders_;
    };
